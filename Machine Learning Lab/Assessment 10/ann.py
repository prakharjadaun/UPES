# -*- coding: utf-8 -*-
"""
Created on Sat Apr  9 11:51:52 2022
...
while checkError(predicted_output,t):
	...
	hidden_layer_output = np.argmax(softmax(hidden_layer_activation))

	output_layer_activation = np.dot(hidden_layer_output,output_weights)
	output_layer_activation += output_bias
	predicted_output = np.argmax(softmax(output_layer_activation))
